...
# Railway hace el healthcheck desde un host interno; debe estar permitido siempre.
...
if not DEBUG:
    ...
    # El healthcheck de Railway llega por HTTP interno; si /healthz se redirige a HTTPS
    # (301) el chequeo falla. Lo eximimos del redirect para que responda 200 directo.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'orders.context_processors.panel_nav',
            ],
        },
    },
]
